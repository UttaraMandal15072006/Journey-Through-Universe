...
//sounds
var fantasy, peace, synthesis, explosion;
...
function preload() {
  ...
  //load sounds
  fantasy=loadSound("fantasy.mp3",true);
  peace=loadSound("peaceful_win_2.mp3");
  synthesis=loadSound("synthesize.mp3");
...
console.log(distance);
  if (gameState === play) 
  {
    ...
    if(frameCount%3000===1)
    {
      textSize(40);
      stroke("red");
  var t=text("Marvellous! Keep Going",width/3,height/2);
      peace.play();
    }
    burst.visible = false;
